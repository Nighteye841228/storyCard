...
<template>
  ...
  <button class="button update-data" @click="isOpenInputText = true">
    更新資料
  </button>
  <div class="modal" :class="{ 'is-active': isOpenInputText }">
    ...
    <div class="modal-card">
      <header class="modal-card-head has-text-left">
        ...
        <button class="delete" aria-label="close" @click="isOpenInputText = false"></button>
      </header>
      <section class="modal-card-body">
        <textarea class="textarea" placeholder="10 lines of textarea" rows="10" v-model="inputWord"></textarea>
      </section>
      <footer class="modal-card-foot">
        <button class="button is-success" @click="updateWord">Save changes</button>
